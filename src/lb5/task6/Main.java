...
public class Main {
    public static void main(String[] args) {
        Task6 two_num_constructor = new Task6(99, 22);

        two_num_constructor.displayMinMax();

        two_num_constructor.setNum(2);
        two_num_constructor.displayMinMax();

        two_num_constructor.setNum(1, 1000);
        two_num_constructor.displayMinMax();

        Task6 one_num_constructor = new Task6(3);

        one_num_constructor.displayMinMax();

        one_num_constructor.setNum(20);
        one_num_constructor.displayMinMax();

        one_num_constructor.setNum(100);
        one_num_constructor.displayMinMax();
