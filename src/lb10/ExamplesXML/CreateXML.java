...
public class CreateXML {
    public static void main(String[] args) {
        try{
            ...
            javax.xml.transform.stream.StreamResult result = new javax.xml.transform.stream.StreamResult(new File("src/lb10/ExamplesXML/exmaple.xml"));
