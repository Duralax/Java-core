...
public class HTMLPasrser2 {
    public static void main(String[] args) {
        try {
            ...
            Elements newsParent = doc.select("body > table > tbody > tr > div > table > tbody " +
                    "> tr:nth-child(5) > td:nth-child(3) > table > tbody > tr > td:nth-child(1)");
